    ...
    def test_with_label(self, data_to_test):
        ...
        for test in data_to_test:
            ...
            if predicted_genre == test[2]:
                print(f"\033[32mFor the movie '{test[0]}' the model said: {predicted_genre}', and was: '{test[2]}'\033[0m")
                corrects += 1.0
            else:
                print(f"\033[31mFor the movie '{test[0]}' the model said: {predicted_genre}', and was: '{test[2]}'\033[0m")
